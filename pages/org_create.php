...
if($_POST) {
    // Set property values
    $orgInfo->pk_org_id = $orgInfo->generateOrgId();
    ...
    if($orgInfo->emailExists()) {
        ...
        if($orgInfo->create()) {
            ...
            $error_message = "Unable to create organization.";
        }
    }
}
?>
...
<head>
    ...
    <title>Create Organization - User Management System</title>
...
<body>
    <div class="container">
        <header class="header">
            <h1><i class="fas fa-building"></i> Create Organization</h1>
            <nav class="nav">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="org_email" name="org_email" class="form-control" 
                               value="<?php echo isset($_POST['org_email']) ? htmlspecialchars($_POST['org_email']) : ''; ?>" 
                               required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="org_password" name="org_password" class="form-control" 
                               value="<?php echo isset($_POST['org_password']) ? htmlspecialchars($_POST['org_password']) : ''; ?>" 
                               required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="org_updated_by" name="org_updated_by" class="form-control" 
                               value="<?php echo isset($_POST['org_updated_by']) ? htmlspecialchars($_POST['org_updated_by']) : ''; ?>" 
                               required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="org_status" name="org_status" class="form-control" required>
                            <option value="A" <?php echo (isset($_POST['org_status']) && $_POST['org_status'] == 'A') ? 'selected' : ''; ?>>Active</option>
                            <option value="I" <?php echo (isset($_POST['org_status']) && $_POST['org_status'] == 'I') ? 'selected' : ''; ?>>Inactive</option>
                        </select>
                    </div>
